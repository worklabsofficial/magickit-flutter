...
class KickstartCommand extends Command<void> {
  ...
  Future<void> run() async {
    ...
    if (!File('lib/core/dependency_injection/injection.dart').existsSync()) {
      logger.err(
    ...
    // ── Register all pages in injection.dart ──────────────────────────────────
...
class _OnboardingPageState extends State<OnboardingPage>
  ...
  @override
  OnboardingCubit createCubit() => sl();
...
class _MainNavigationPageState extends State<MainNavigationPage>
  ...
  @override
  MainNavigationCubit createCubit() => sl();
